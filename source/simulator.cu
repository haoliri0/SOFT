...
static __host__
void cuda_init_table(cudaStream_t const &stream, ShotsStatePtr const &shots_state_ptr) {
...
static __host__
void cuda_init_entries(cudaStream_t const &stream, ShotsStatePtr const &shots_state_ptr) {
    const Sid shots_n = shots_state_ptr.shots_n;
