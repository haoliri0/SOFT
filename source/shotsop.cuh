...
template<typename Args, void (*op)(ShotStatePtr shot_state_ptr, Args args)>
static __host__
void cuda_shots_op(cudaStream_t const &stream, ShotsStatePtr const &shots_state_ptr, Args args) {
...
template<void (*op)(ShotStatePtr shot_state_ptr)>
static __host__
void cuda_shots_op(cudaStream_t const &stream, ShotsStatePtr const &shots_state_ptr) {
    const Sid shots_n = shots_state_ptr.shots_n;
